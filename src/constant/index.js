...
export const REDIRECT_URL = 'https://wx.hn.189.cn/hnimgs/wx_view/schoolPhone/index.html'
const SCOPE = 'snsapi_userinfo'
const STATE = ''
export const AUTHURL = `https://open.weixin.qq.com/connect/oauth2/authorize?appid=${APPID}&redirect_uri=${REDIRECT_URL}&response_type=code&scope=${SCOPE}&state=${STATE}#wechat_redirect`
